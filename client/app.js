      ...
      if (error) {
        ...
        exec('pidof text-scroller', (error, stdout, stderr) => {
          if (error) {
            ...
            exec(`sudo /home/soren/matrix/rpi-rgb-led-matrix/utils/led-image-viewer -C --led-rows=32 --led-cols=64 --led-swap-green-blue --led-brightness=${brightness.toString()} /home/soren/matrix/client/downloads/*`);
            return;
          }
          else {
